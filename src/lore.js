...
TARQUIN SOLL & THE FOUNDING. In the Sordish Civil War (1928–29), three generals fought over the collapsed republic: the hard-right nationalist Eduard Luderin (who had seized power in a 1927 coup) and the communist Iannick Rikard both harboured totalitarian designs. Colonel Tarquin Soll, commanding a neutral army, defeated both, restored the republic, founded the USP, wrote the 1929 Constitution, and ruled about 21 years. He modernised the country — schools, industry, welfare — but grew authoritarian: a personality cult and the suppression of the Bludish minority. Because he was the least-bad of three would-be tyrants, most Sords — even liberals — revere the man as a founding father and resent mainly his authoritarian legacy, not the man himself. Soll is still alive in 1954 and holds a permanent, unelected seat in the Grand National Assembly.
...
NATIONAL CHARACTER. A proud military tradition, a strikingly young population (over half under 30), and a deep, shared reverence for the republic Soll rescued — even among those who want it to grow freer.`;
